...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  return (
    <div className="flex flex-col min-h-screen bg-[#fcfdfc] text-slate-600 font-sans overflow-x-hidden selection:bg-green-200 selection:text-green-900 relative">
      <Header />
